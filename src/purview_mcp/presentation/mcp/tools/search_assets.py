...
def register(mcp: FastMCP, use_case: SearchAssetsUseCase) -> None:
    ...
    async def search_assets(
        ...
        Returns only assets that HAVE a description, with name, type, description,
        owners, classification tags, and endorsement status (Certified / Promoted).
        Use search_undocumented_assets to find assets missing a description.
